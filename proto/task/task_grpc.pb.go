...
type TaskServiceClient interface {
	...
	ListUserTasks(ctx context.Context, in *ListUserTasksRequest, opts ...grpc.CallOption) (*ListTaskResponse, error)
}
...
func (c *taskServiceClient) ListUserTasks(ctx context.Context, in *ListUserTasksRequest, opts ...grpc.CallOption) (*ListTaskResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListTaskResponse)
...
type TaskServiceServer interface {
	...
	ListUserTasks(context.Context, *ListUserTasksRequest) (*ListTaskResponse, error)
...
func (UnimplementedTaskServiceServer) ListUserTasks(context.Context, *ListUserTasksRequest) (*ListTaskResponse, error) {
